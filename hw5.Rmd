...
As the effect size increases, the proportion of tests that reject the null increases until it is at 100%. 
...
It is approximately equal for most values, except when the true value is close to the null value of 0. When the true and null values are close, the t-test is less likely to reject the null. This pushes the mean estimate for rejected tests up. 
